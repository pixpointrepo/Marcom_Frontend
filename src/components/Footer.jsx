...
import React from "react";
import logo from "../assets/images/pixpointLogo.png";
    ...
    <footer className="bg-black text-gray-300 text-sm pt-5 px-5">
        <div className="flex flex-col" >
              ...
              <div>
                ...
                <img src={logo} className="h-20 ml-3 my-4 " alt="" />
                ...
                <h4 className="text-lg font-semibold my-4 text-main">Follow Us</h4>
                <div className="flex gap-4">
                  {platformSvgs.map((platform, index) => (
                    <a
                      key={index}
                      href={`#${platform.name}`}
                      className="w-10 h-10 flex justify-center items-center bg-gray-700 rounded-full hover:bg-secondary text-gray-300 hover:text-white transition-all duration-300 transform hover:-translate-y-1"
                    >
                      {platform.icon}
                    </a>
                  ))}
